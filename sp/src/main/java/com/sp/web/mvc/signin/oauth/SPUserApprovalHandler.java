...
public class SPUserApprovalHandler extends ApprovalStoreUserApprovalHandler {
  ...
  public AuthorizationRequest checkForPreApproval(AuthorizationRequest authorizationRequest,
    ...
    if (useApprovalStore) {
      ...
      if (clientDetailsService != null) {
        ...
        try {
          ClientDetails client = clientDetailsService.loadClientByClientId(authorizationRequest
              .getClientId());
